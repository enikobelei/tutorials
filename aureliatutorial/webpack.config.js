...
module.exports = ({production, server, extractCss, coverage, analyze, karma} = {}) => ({
  ...
  plugins: [
    ...
    new ModuleDependenciesPlugin({
      ...
      "aurelia-i18n": [
        { name: 'locales/en/nav.json', chunk: 'lang-en' },
        { name: 'locales/en/post-form.json', chunk: 'lang-en' },
        { name: 'locales/fr/nav.json', chunk: 'lang-fr' },
        { name: 'locales/fr/post-form.json', chunk: 'lang-fr' }
      ]
    }),
